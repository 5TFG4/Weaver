...
- [x] All routes use `Depends()` from `dependencies.py`
- [x] No module-level service singletons remain
- [x] `runs.Created` event emitted on POST /runs
- [x] SSE client receives events from EventLog
- [x] All 506 tests passing (+13 new tests)
